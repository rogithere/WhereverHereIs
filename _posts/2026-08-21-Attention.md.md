...
At the outset let us admit that it is impossible to discard it. To be human is to feel. Feelings occur as a consequence of desire and it’s dynamics. This is the first tiny step towards our goal. This idea is not new. It has found utterance in many cultures, places and across times. The modern commonplace way of saying proffering this advice is to say “grow up” or “act mature”. I should warn you that it is a loaded phrase. 

Now say a person (P) gives this advice to their friend (Q). Let us also assume that both the advisor & the advisee are sincere. How should Q follow through on P’s wise words ? Growing up is a biological process. This happens to us irrespective of our wishes to the contrary. The issue then is that growing also refers to how one acts when one has certain experience and skill which can be (should?) acquired by a certain age. The relationship between experience and skill is assumed here is the following -

a. Experience is what happens to us 

b. Skill is how we learn to think about it/ process it.   
  
In other words - growing up refers to be able to think about our experiences.   
One also learns in due course that not all ways of thinking about our experiences are fruitful. In other words, making our actions the center of our attention can help us manage our desire. Our attention is all we have and therefore as the famous Google parable goes ‘Attention is all you need’. Couldn’t help the pun!  
...
Hopefully I can develop this further. Next time I’ll write about rainbows and sunshine and some cool science-y stuff.
